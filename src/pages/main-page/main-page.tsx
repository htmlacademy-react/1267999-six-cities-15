...
function MainPage({ cardsCount }: TMainPageProps) {
  const cartsItems = Array.from({ length: cardsCount }).map((_, index) => (
    <CartItem key={index} />
  ));
  return (
    <MainLayout header={<Header isNav />} className={LayoutClassName.Main}>
      <Helmet>
